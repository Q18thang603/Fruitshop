...
export default function Home({ search, category, setCategory }) {
  ...
  const serviceItems = [
    { icon: Truck, title: "Giao hàng nhanh", text: "Giao trong 2h nội thành", color: "text-primary-600" },
    { icon: RefreshCcw, title: "Đổi trả dễ dàng", text: "Đổi trả trong 7 ngày", color: "text-primary-650" },
    { icon: CheckCircle, title: "Sản phẩm chất lượng", text: "100% tươi ngon, rõ nguồn gốc", color: "text-primary-700" },
    { icon: HelpCircle, title: "Tư vấn tận tâm", text: "Hỗ trợ 24/7, đặt hàng dễ dàng", color: "text-primary-600" }
  ];

  // Get first 4 products for best sellers section
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/products" className="text-primary-600 font-bold hover:text-primary-700 flex items-center gap-1.5 transition-colors text-sm">
...
=======
              ...
              >
                ...
                <div className="flex-1 pl-4 flex flex-col justify-center items-start text-left relative z-10">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-black text-slate-800 group-hover:text-primary-600 transition-colors">
                      {item.title}
                    </span>
                  </div>
                ...
                <div className="absolute -bottom-6 -right-6 w-20 h-20 bg-primary-50 rounded-full blur-2xl group-hover:scale-150 transition-transform" />
              </Link>
            ))}
          </div>
        </div>
      ...
      {/* 3. THỰC PHẨM HỮU CƠ (Main List Section) */}
      <section className="py-16" id="products">
        <div className="container mx-auto px-4">
...
=======
                  className={`px-6 py-2.5 rounded-xl font-bold text-xs transition-all duration-300 uppercase ${
                    category === cat 
